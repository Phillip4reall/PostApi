              ...
              children: [
                Stack(
                  ...
                  children: [
                    CircleAvatar(
                      radius: 40,
                     // backgroundImage: NetworkImage('url'), // 👈 Add your asset
                    ),
                ...
                const SizedBox(height: 6),
                 ...
                 Text('Support Team', style: TextStyle(color: Colors.grey.shade400,)),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(label2, style: const TextStyle(fontSize: 16,color: Colors.white)),
            ],
          ),
        ],
      ),
